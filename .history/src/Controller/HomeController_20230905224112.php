...
class HomeController extends AbstractController
{
    ...
    public function index(
        ...
        foreach (['Chine', 'bresil', 'cameroun', 'île Maurice'] as $category) {
            $entrees = array_merge($entrees,  $productRepository->findProductsByCategoryAndType($category, 'Entrée'));
            $plats = array_merge($plats, $productRepository->findProductsByCategoryAndType($category, 'Plat');
            $desserts[] = array_merge($productRepository->findProductsByCategoryAndType($category, 'Dessert');
        }
