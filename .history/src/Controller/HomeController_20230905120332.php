...
class HomeController extends AbstractController
{
    ...
    public function index(
        ...
        $entrees = $productRepository->findProductsByCategoryAndType('Chine','bresil','cameroun', 'Entrée');
        $plats = $productRepository->findProductsByCategoryAndType('Chine','bresil','cameroun', 'Plat');
        $desserts = $productRepository->findProductsByCategoryAndType('Chine','bresil','cameroun', 'Dessert');
