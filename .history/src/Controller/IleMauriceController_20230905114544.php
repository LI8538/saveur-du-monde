...
class mauriceController extends AbstractController
{
    #[Route('/maurice', name: 'app_maurice', methods: ['GET'])]
    public function index(ProductRepository $productRepository): Response
    {
        $entrees = $productRepository->findProductsByCategoryAndType('maurice', 'Entrée');
