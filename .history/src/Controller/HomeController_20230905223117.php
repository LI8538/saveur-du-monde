...
class HomeController extends AbstractController
{
    ...
    public function index(
        ...
        $entrees = $productRepository->findProductsByCategoryAndType('Chine','bresil','cameroun','île Maurice', 'Entrée') + $productRepository->findProductsByCategoryAndType('Chine','bresil','cameroun','île Maurice', 'Entrée');
